...
<div style="display:flex;justify-content:center;align-items:center;min-height:50vh;">
  <div style="background:rgba(255,255,255,0.04);backdrop-filter:blur(12px);
    ...
    # https://img.icons8.com/fluency/512/diamond.png ONLY FOR DISPLAY (IMPORTANT FIX)
    ...
    source = q.get("source", "AI").capitalize()
    source_icon = '<img src="https://img.icons8.com/fluency/512/green-circle.png" width="20" style="vertical-align:-4px;">' if source == "Ollama" else '<img src="https://img.icons8.com/fluency/512/blue-circle.png" width="20" style="vertical-align:-4px;">' if source == "Groq" else '<img src="https://img.icons8.com/fluency/512/rocket.png" width="20" style="vertical-align:-4px;">'
    st.caption(f"{source_icon} Generated by {source}", unsafe_allow_html=True)
    ...
    if st.button("Submit Answer →", use_container_width=True):
        ...
        # https://img.icons8.com/fluency/512/fire-element.png FIXED ADAPTIVE LOGIC
